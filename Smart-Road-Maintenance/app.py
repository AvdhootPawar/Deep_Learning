    ...
    if vid_file_path:
        ...
        try:
            ...
            while cap.isOpened(): # Loop while capture is open
                ...
                output_image.image(processed_frame, caption="Pothole Detection Result", use_container_width=True)
...
def image_input(data_src, confidence, uploaded_file_obj):
    ...
    if img_array is not None:
        try:
            ...
            with col_proc:
                st.image(processed_image, caption="Pothole Detection Result (with Confidence)", use_container_width=True)
...
def webcam_input(confidence):
    ...
    try:
        ...
        while cap.isOpened() and not stop_button_pressed:
            ...
            processed_frame, detections = process_frame(frame_rgb, confidence)
            output_image.image(processed_frame, caption="Webcam Pothole Detection", use_container_width=True)
